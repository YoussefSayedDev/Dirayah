...
export default function ArchiveDummyData() {
...
//     switch (role) {
//       case "student":
//         await updateOnboardingStatus(false, 0, { role });
//         break;
//       case "teacher":
//         await updateOnboardingStatus(false, 1, { role });
//         break;
//       case "parent":
//         await updateOnboardingStatus(false, 2, { role });
//         break;
//       default:
//         break;
//     }
...
//             <RoleCard
//               title={t("main.roles.admin.title")}
//               description={t("main.roles.admin.description")}
